                    ...
                    <div class="sherah-body">
                        ...
                        <div class="sherah-dsinner">
                            ...
                            <div class="sherah-table sherah-page-inner sherah-border sherah-default-bg mg-top-25">
                                ...
                                <p>Customer: ${orderProductDetails.order.firstName} ${orderProductDetails.order.lastName}</p>
                                ...
                                <table class="sherah-table__main">
                                    ...
                                    <tbody class="sherah-table__body">
                                        <c:forEach var="product" items="${orderProductDetails.products}">
                                            <tr>
                                                <td><img src="images/${product.hinh1}" alt="Product Image" style="width: 50px;"></td>
                                                <td>${product.tenSP}</td>
                                                <td>${product.giaBan}</td>
                                                <td>
                                                    <form action="orderdetails" method="post" style="display:inline;">
                                                        <input type="hidden" name="orderID" value="${orderProductDetails.order.orderID}">
                                                        <input type="hidden" name="maSP" value="${product.maSP}">
                                                        <input type="number" name="quantity" class="form-control form-control-quantity" value="${product.soLuong}">
