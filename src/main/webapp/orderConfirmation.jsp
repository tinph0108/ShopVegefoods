        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <p class="breadcrumbs"><span class="mr-2"><a href="index">Home</a></span> <span>Order Confirmation</span></p>
                    <h1 class="mb-0 bread">Order Confirmation</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 ftco-animate">
                    <div class="alert alert-success" role="alert">
                        ...
                        <hr>
                        <p class="mb-0">You can <a href="#" class="alert-link">continue shopping</a> or go to your <a href="orderHistory" class="alert-link">order history</a>.</p>
                    </div>
                </div>
            </div>
        </div>
