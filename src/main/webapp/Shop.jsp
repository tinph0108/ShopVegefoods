							...
							<ul
								...
								<c:if test="${sessionScope.acc.admin == true}">
									...
									<li><a class="dropdown-item d-flex align-items-center"
                                        ...
                                        </svg> <span style="margin-left: 8px">Trang
												quản lý</span>
									</a></li>
								</c:if>
								...
								<li><a class="dropdown-item d-flex align-items-center"
                                    ...
                                    </svg> <span style="margin-left: 8px">
											Sign Out</span>
								</a></li>
							</ul></li>
					</c:if>
					...
					<div class="mb-5 text-left">
						...
						<ul class="product-category"
							...
							<li style="margin-bottom: 10px;"><a
								href="category?maDanhMuc=all"
								class="${param.maDanhMuc == 'all' || param.maDanhMuc == null ? 'active' : ''}">All</a>
							</li>
							<c:forEach items="${categories}" var="o">
								<li style="margin-bottom: 10px;"><a
									href="category?maDanhMuc=${o.maDanhMuc}"
									class="${param.maDanhMuc == o.maDanhMuc ? 'active' : ''}">${o.tenDanhMuc}</a>
								</li>
							</c:forEach>
						</ul>
						<div class="mt-4">
							...
							<form action="search" method="post">
								<div class="input-group">
									<input name="txt" type="text" class="form-control"
										placeholder="Search for products..." name="query" required
