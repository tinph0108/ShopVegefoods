						...
						<ul class="menu-bar__one sherah-dashboard-menu" id="sherahMenu">
                            ...
                            <g id="Icon" transform="translate(0 0)">
                                ...
                                <path id="Path_32" data-name="Path 32"
									...
									</span> <span class="menu-bar__name">Dashboard</span>
								</span>
							</a></span></li>

							<c:if test="${sessionScope.acc.admin}">
								<li><a href="viewAccounts" class="collapsed"
                                ...
                                <g id="Icon"
                                    ...
                                    <path id="Path_211"
										...
										</span> <span class="menu-bar__name">Customers</span>
									</span>
								</a></span>
							</c:if>

							<li><a href="manager" class="collapsed"
								data-bs-toggle="collapse" data-bs-target="#menu-item_products">
                            ...
                            <path id="Path_218" data-name="Path 218"
									...
									</span> <span class="menu-bar__name">Products</span>
								</span>
							</a></span></li>

							<li><a href="orderlist" class="collapsed"> <span
									class="menu-bar__text"> <span
										class="sherah-menu-icon sherah-svg-icon__v1"> <svg
												class="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg"
												width="19.434" height="19.432" viewBox="0 0 19.434 19.432">
                            <g id="Icon"
													transform="translate(791.246 88.341)">
                                ...
                                <path id="Path_547" data-name="Path 547"
									...
									</span> <span class="menu-bar__name">Orders</span>
								</span>
							</a></span></li>
                            ...
                            <g id="Icon"
													transform="translate(-115.401 35.25)">
                                <path id="Path_1026"
													data-name="Path 1026"
                                ...
                                <path id="Path_1028"
									...
									</span> <span class="menu-bar__name">History</span>
								</span>
							</a></span></li>
                            ...
                            <g id="Icon"
                                ...
                                <g id="setting"
									...
									</span> <span class="menu-bar__name">Settings</span>
								</span>
							</a></span></li>
						</ul>
					</div>
								...
								<div class="row mg-top-10">
											...
											<div class="sherah-progress-card__content">
												<div class="sherah-progress-card__heading">
													...
													<h4 class="sherah-progress-card__title">
														<b class="count-animate">722.500 VNĐ</b>
													</h4>
												</div>
									...
									<div class="col-lg-3 col-md-6 col-12">
										...
										<div
											...
											<div class="sherah-progress-card__content">
												<div class="sherah-progress-card__heading">
													<span class="sherah-pcolor">Monthly Visitors </span>
													<h4 class="sherah-progress-card__title">
														<b class="count-animate">536</b>
													</h4>
												</div>
												<div class="sherah-progress-card__button">
										...
										<div class="row">
												...
												<div
													...
													<div class="sherah-order-card__first">
														<p class="sherah-order-card__text mg-btm-10">
															Active Creator <span class="sherah-bcolor"></span>
														</p>
														<div
											...
											<div class="col-lg-6 col-md-6 col-12">
												...
												<div
													...
													<div class="sherah-order-card__first">
														<p class="sherah-order-card__text mg-btm-10">
															Recent Order <span class="sherah-bcolor"></span>
														</p>
														<div
															class="sherah-chart__inside sherah-chart__inside--aorder">
