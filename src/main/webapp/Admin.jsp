...
<div class="admin-menu__one sherah-sidebar-padding">
    ...
    <div class="menu-bar">
        <ul class="menu-bar__one sherah-dashboard-menu" id="sherahMenu">
            <li><a href="#!" data-bs-toggle="collapse" data-bs-target="#menu-item_home">
            ...
            <c:if test="${sessionScope.acc.admin}">
                <li><a href="viewAccounts" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item__customers">
                    <span class="menu-bar__text"> 
                        <span class="sherah-menu-icon sherah-svg-icon__v1"> 
            ...
            <li><a href="manager" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item_products">
                <span class="menu-bar__text"> 
                    <span class="sherah-menu-icon sherah-svg-icon__v1"> 
                    ...
                    <span class="menu-bar__name">Products</span>
                </span> 
            </a></span></li>
            ...
            <li><a href="history.html" class="collapsed">
                <span class="menu-bar__text"> 
                    <span class="sherah-menu-icon sherah-svg-icon__v1"> 
                    ...
                    <span class="menu-bar__name">History</span>
                </span> 
            </a></span></li>

            <li><a class="collapsed" href="profile-info.html">
                <span class="menu-bar__text"> 
                    <span class="sherah-menu-icon sherah-svg-icon__v1"> 
