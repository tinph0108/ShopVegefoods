        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Shop</a>
                ...
                <form class="form-inline my-2 my-lg-0 mx-auto search-form" onsubmit="return false;">
                    <input class="form-control search-input" type="search" id="search-query" placeholder="Bạn muốn chọn ăn gì?" aria-label="Search" onkeyup="searchProducts()">
                ...
                <ul class="navbar-nav ml-auto">
                    <c:if test="${sessionScope.acc != null}">
                        ...
                        <li class="nav-item dropdown pe-3 nav-profile">
                            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown"> 
                                ...
                                <span style="margin-left: 10px" class="d-none d-md-block dropdown-toggle ps-2">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                                ...
                                <li>
                                    <a class="dropdown-item d-flex align-items-center" href="pages-faq.html"> 
                                        ...
                                        <span style="margin-left: 8px">Need Help?</span>
                                    </a>
                                </li>
                                <li><hr class="dropdown-divider"></li>
                                <li>
                    ...
                    <c:if test="${sessionScope.acc == null}">
                        <li class="nav-item"><a href="Login.jsp" class="nav-link"><i class="fas fa-sign-in-alt"></i> Login</a></li>
                    </c:if>
                </ul>
            </div>
        </div>
